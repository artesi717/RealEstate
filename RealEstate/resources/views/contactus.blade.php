...
<div class="contenti11">
  <div class="row1111">
    ...
    <div class="pjesaime2">
      ...
      <input class="inputi1" type="text" placeholder="First name"> <br> <br>
      <input class="inputi1" type="email" placeholder="Email address"> <br> <br>
      <input class="inputi1" type="number" placeholder="Phone number"> <br> <br>
      <textarea class="inputi1" type="text" placeholder="Message"></textarea> <br>
      <a href="#" class="myButton1">Send messsage</a>
