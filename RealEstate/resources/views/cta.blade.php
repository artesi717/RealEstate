<link rel="stylesheet" href="{{ URL::asset('css/cta.css') }}">
<link rel="stylesheet" href="bower_components/aos/dist/aos.css">
<script src="bower_components/aos/dist/aos.js"></script>
<link href="https://cdn.rawgit.com/michalsnik/aos/2.1.1/dist/aos.css" rel="stylesheet">
<script src="https://cdn.rawgit.com/michalsnik/aos/2.1.1/dist/aos.js"></script>

<div style="padding-left:30%;" class="row row-cols-1 row-cols-md-3 g-4 cardat1" data-aos="fade-left">
  <div class="col">
    <div class="card h-100">
      <img src="https://www.zillowstatic.com/s3/homepage/static/Buy_a_home.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title titulli">Buy a home</h5>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="https://www.zillowstatic.com/s3/homepage/static/Sell_a_home.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title titulli">Sell a home</h5>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="https://www.zillowstatic.com/s3/homepage/static/Rent_a_home.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title titulli">Rent a home</h5>
